This reporting tool is created from a Python program/script with SQL queries to a news database. Displays the most popular articles, peak times of website access, and website crash dates/time. 
